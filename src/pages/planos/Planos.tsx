      ...
      <div className="bg-gradient-to-b from-sky-200 to-sky-600 py-10 min-h-screen">
        <div className="container mx-auto flex flex-col items-center text-center px-4">
          ...
          <div className="flex gap-4" >
            ...
            <p className="mb-4 text-sm text-black">Ideal para quem quer começar ou manter a rotina com economia.</p>
              <div className="text-3xl font-bold text-black mb-2">R$ 49,90 
                <span className="text-sm font-normal">/mês</span> 
              </div>
              <button className="mt-4 bg-sky-500 hover:bg-sky-600 text-white font-semibold py-2 px-4 rounded cursor-pointer transition">
                Assinar agora
              </button>
          </div>
            <div className="bg-black rounded-2xl shadow-lg p-6 w-full max-w-sm">
            <h2 className="text-2xl font-extrabold text-sky-400 mb-2 border-b border-sky-400 pb-2">Plano Premium</h2>
            <p className="mb-4 text-sm text-gray-300">Ideal para quem quer começar ou manter a rotina com economia.</p>
              <div className="text-3xl font-bold text-white mb-2">R$ 79,90 
                <span className="text-sm font-normal">/mês</span> 
              </div>
              <button className="mt-4 bg-sky-500 hover:bg-sky-600 text-white font-semibold py-2 px-4 rounded cursor-pointer transition">
                Assinar agora
