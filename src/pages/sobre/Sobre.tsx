...
function Sobre() {
  ...
  return (
    <>
    <section className="w-full min-h-screen gap-4 text-2xl text-white bg-[url('https://ik.imagekit.io/illaoi/gen%20sobre%20m.png?updatedAt=1754585149142')] bg-cover bg-center bg-fixed">
