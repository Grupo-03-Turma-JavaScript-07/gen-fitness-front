  ...
  return (
    <>
      <main className=" bg-black">
        ...
        <section className="grid gap-8  bg-conic-120 from-blue-700 via-blue-400 to-black rounded-2xl ml-2 p-10 ">
            <form className="flex flex-col p-5 rounded-2xl shadow-lg bg-white/5 w-full " onSubmit={msg}>
              ...
              <h3 className="font-medium text-white/90 text-center shadow-inner bg-black/5 p-2 my-1 mx-auto w-70% ">Conheça versões exclusivas!
                ...
                <div className="flex gap-2">
                  <label htmlFor="nome" className="text-white font-bold text-shadow-sm p-1 my-2">Nome:</label>
                  <input
                    type="text"
                    placeholder="Digite seu nome"
                    name="nome"
                    required
                    className="border-1 w-140 border-white rounded-3xl placeholder:text-[#ffffff80] p-1 my-2" />
                </div>
              <div className="flex flex-col gap-4">
                <div className="flex flex-col-2 gap-2">
                  <label htmlFor="email" className="text-white font-bold text-shadow-sm p-1 my-2">E-mail:</label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col-2 gap-2">
                  <label htmlFor="assunto" className="text-white font-bold text-shadow-sm p-1 my-2">Assunto:</label>
                  <input
                    type="text"
                    placeholder="Sobre o que deseja falar?"
                    name="assunto"
                    required
                    className="border-1 w-136 border-white rounded-3xl placeholder:text-[#ffffff80] p-1 my-2" />
                </div>
                <div className="flex flex-col-2 gap-2">
                  <label htmlFor="mensagem" className="text-white font-bold text-shadow-sm p-1 my-2">Mensagem:</label>
                  <textarea
                    placeholder="Digite a sua mensagem"
                    name="mensagem"
                    required
                    className="border-1 w-130 border-white rounded-2xl placeholder:text-[#ffffff80] p-1 my-2" />
                </div>
                <button
                  type='submit'
        ...
        <section className="grid grid-cols-2 w-auto h-fit container mx-auto items-center justify-center gap-10 p-5">
          ...
          <div className="bg-white rounded-2xl shadow-lg shadow-white/25 p-6">
            ...
            <p className="mb-10">Online: 24h</p>
            <div className="flex gap-4 mb-2 border-b border-blue-500 pb-2">
            <ChatsCircleIcon size={32} color="#2b7fff" weight="fill" />
            <h2 className="text-2xl font-extrabold text-blue-500  justify-center ">CONTATOS</h2>
            </div>
            <h3 className="font-bold pt-1">TELEFONE:
            </h3>
            <p mb-4 text-sm text-black>+55 011 1234-5678</p>
            <hr className="w-1/4 h-0.5 mx-auto mb-2 bg-black/30 border-0" />
